...
func main() {
	...
	for goRoutine := 0; goRoutine < 5; goRoutine++ {
		...
		go func(index int) {
			...
			if err = ch.ExchangeDeclare("logs_direct", "direct", true, false, false, false, nil); err != nil {
			...
			for _, key := range bindingKeys {
				if err = ch.QueueBind(q.Name, key, "logs_direct", false, nil); err != nil {
